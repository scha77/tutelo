...
describe('sendBookingConfirmationEmail (NOTIF-03)', () => {
  it.todo('sends to both parent email and teacher social_email')

  it.todo('email to parent uses BookingConfirmationEmail template')

  it.todo('email to teacher uses BookingConfirmationEmail template (or a variant)')
})
