...
| S02 | Directory Pages ISR | low | S01 | ⬜ | After this: /tutors base page and all /tutors/[category] pages are served from CDN cache; filter UX still works; new published teachers appear in directory within the revalidation window. |
