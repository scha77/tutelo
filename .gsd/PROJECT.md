...
---
*Last updated: 2026-04-01 after M010/S03 completion — Saved Payment Methods. parent_profiles table (migration 0018), create-intent/create-recurring Customer reuse, webhook PM upsert, /parent/payment page, Payment nav item. 18 new unit tests. Full test suite: 444 tests across 48 files, 0 failures.*
